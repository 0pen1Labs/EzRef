    ...
    <div className="peer/endDomain flex flex-row rounded-md border border-foreground/20 bg-background px-4 py-1">
      <div className="flex flex-row items-center space-x-4">
        <svg
          ...
          strokeWidth="1.5"
          stroke="currentColor"
          className="h-6 w-6 stroke-foreground/80"
        >
          <path
            strokeLinecap="round"
      ...
      <form className="ms-2 flex w-full flex-grow flex-row items-center justify-between space-x-4">
        ...
        <button
          type="submit"
          className="flow-row group ms-2 flex items-center border-none bg-transparent outline-none"
        >
          <span className="text-base font-light text-foreground group-hover:text-foreground/50">
            Generate
          </span>
          <Image
            src={Hat}
            alt="magic link generate button"
            width={0}
            height={0}
            className="mx-4 h-10 w-5"
          />
        </button>
      </form>
    </div>
